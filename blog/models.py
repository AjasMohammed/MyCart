...
class Blogpost(models.Model):
    ...
    cont_head0 = models.CharField(max_length=5000, default="")
    head1 = models.CharField(max_length=5000, default="")
    cont_head1 = models.CharField(max_length=5000, default="")
    head2 = models.CharField(max_length=5000, default="")
    cont_head2 = models.CharField(max_length=5000, default="")
